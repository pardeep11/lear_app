...
def get_columns(periodicity, period_list, accumulated_values=1, company=None):
	...
	columns.append({
		"fieldname": "period_variance",
		"label": _("Period Variance"),
		"fieldtype": "Percent",
	})

	columns.append({
		"fieldname": "period_budget",
		"label": _("Period Budget"),
		"fieldtype": "Currency",
		"options": "currency",
	})
	...
	columns.append({
		"fieldname": "last_ytd",
		"label": _("Last year YTD revenue or cost"),
		"fieldtype": "Currency",
		"options": "currency",
	})
